...
set "SCENE=res://scenes/tests/Test_ProcMazeMap_NoCeilingPreview.tscn"
...
set "LOG_FILE=%LOG_DIR%\run_proc_maze_no_ceiling_preview.log"
...
echo Running no-ceiling procedural maze preview.
