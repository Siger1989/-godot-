...
set "LOG_FILE=%LOG_DIR%\run_game.log"
...
echo Running Backrooms formal game.
echo Project: %PROJECT_DIR%
echo Main scene: project.godot application/run/main_scene
echo Log: %LOG_FILE%
echo.
"%GODOT_CONSOLE_EXE%" --path "%PROJECT_DIR%" --log-file "%LOG_FILE%"
